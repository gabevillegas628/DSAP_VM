...
const DraggableChromogramModal = ({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="absolute bg-white rounded-lg shadow-2xl pointer-events-auto flex flex-col"
        style={{
          left: `${position.x}px`,
          top: `${position.y}px`,
          width: '80vw',
      ...
      >
        {/* Draggable Header */}
        <div
          className={`drag-handle bg-gradient-to-r from-purple-600 to-indigo-600 p-4 text-white rounded-t-lg ${
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              {fileName && (
                <span className="text-sm text-purple-100">- {fileName}</span>
              )}
            </div>
            <button
              onClick={onClose}
